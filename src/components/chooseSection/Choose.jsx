...
const Choose = () => {
  ...
  return (
    <section className="my-container my-[clamp(7rem,6vw,7.5rem)]">
      <h2 className="text-[clamp(2.75rem,5vw,3rem)] font-bold mb-2 text-center">Get Started in 3 Steps</h2>
      <p className="text-sm text-gray-400 mb-8 text-center">Start using premium digital tools in minutes, not hours.</p>
